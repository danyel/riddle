package be.riddler.v1.menu.adapter;

import be.riddler.v1.menu.adapter.entity.MenuConfigurationEntity;
import be.riddler.v1.menu.adapter.repository.MenuConfigurationRepository;
import be.riddler.v1.menu.adapter.repository.MenuRepository;
