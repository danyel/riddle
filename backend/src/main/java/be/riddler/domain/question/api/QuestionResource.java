...
class QuestionResource implements QuestionApi {
    ...
    private static @NonNull Question map(be.riddler.domain.question.domain.Question question) {
    ...
    public Question create(CreateQuestion createQuestion) {
        var question = new be.riddler.domain.question.domain.Question(createQuestion.question(), createQuestion.type());
