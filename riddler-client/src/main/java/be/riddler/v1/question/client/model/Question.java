...
public record Question(
    ...
    public Question(@NonNull UUID id, @NonNull String title, @NonNull String question, @NonNull QuestionType type, @NonNull List<@NonNull Option> options) {
        this(id, title, question, type, MULTIPLE_CHOICE.equals(type), SINGLE_CHOICE.equals(type), OPEN.equals(type), REVIEW.equals(type), options);
    }

    public Question(@NonNull UUID id, @NonNull String title, @NonNull String question, @NonNull QuestionType type) {
        this(id, title, question, type, MULTIPLE_CHOICE.equals(type), SINGLE_CHOICE.equals(type), OPEN.equals(type), REVIEW.equals(type), new ArrayList<>());
    }

    public Question(@NonNull String title, @NonNull String question, @NonNull QuestionType type) {
        this(null, title, question, type, MULTIPLE_CHOICE.equals(type), SINGLE_CHOICE.equals(type), OPEN.equals(type), REVIEW.equals(type), new ArrayList<>());
    }
}
